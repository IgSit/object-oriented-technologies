...
public class PhotoCrawler {
    ...
    public void downloadPhotoExamples() {
        ...
        try {
            Observable<Photo> observator = photoDownloader.getPhotoExamples();
            observator.subscribe(photoSerializer::savePhoto);
        } catch (IOException e) {
    ...
    private void downloadAndSavePhotos(Observable<Photo> photoObservable, int count) {
        photoObservable
                .take(count)
